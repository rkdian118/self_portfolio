...
const seedDatabase = async (): Promise<void> => {
  try {
    ...
    const hero = await Hero.create({
      ...
      cvUrl:
        "https://drive.google.com/uc?export=download&id=1r5bX6Yk1n8b0u3jz8Fqj5c6H7x9y2zA1",
    });
    ...
    const projects = await Project.insertMany([
      ...
      },
      {
        ...
        skills:
          "Node.js, Express.js, React.js, MongoDB, AWS EC2, Route 53, Nginx",
    ...
    const experiences = await Experience.insertMany([
      {
        ...
        description:
          "Designed and implemented a scalable microservices architecture to enhance modularity and maintainability of applications. Managed and integrated highly available MongoDB databases ensuring data consistency.",
        order: 1,
      },
      {
        ...
        description:
          "Collaborated actively with clients and internal teams to gather detailed user requirements and translate these into technical solutions.",
        order: 2,
      },
      {
        order: 3,
