...
const randomPercent = () => Math.floor(Math.random() * 80) + 10; // 10% - 90%
const randomDuration = () => (Math.random() * 7 + 5).toFixed(2) + "s"; // 5-12s
const randomDelay = () => (Math.random() * 10).toFixed(2) + "s"; // 0-10s
